...
var _vueProgressbar = require('./vue-progressbar.vue'),
  _vueProgressbar2 = _interopRequireDefault(_vueProgressbar);
...
function assign(a) { // eslint-disable-line no-unused-vars
  for (var c, d, b = 1; b < arguments.length; ++b)
    for (c in d = arguments[b], d) Object.prototype.hasOwnProperty.call(d, c) && (a[c] = d[c]);
  return a
}
  ...
  var c = 'undefined' != typeof window,
    d = {
      ...
      hide: function hide() {
        ...
        }, _this2.$vm.RADON_LOADING_BAR.options.transition.termination)
      },
